...
print("Result:", result)
empty_result = analyze_list([])
print("Cписок порожній:", empty_result)
# -------------------------------------------------------------------------------------
...
original_list = [5, 2, 8, 1]
sorted_list = get_sorted_list(original_list)
print("Sorted:", sorted_list)  # повинно вивести [1, 2, 5, 8]
...
def join_with_me(*args, separator=":"):
    result = separator.join(map(str, args))
    return result
print(join_with_me(1,2,3, separator=":"))
print(join_with_me(1,2,3, separator=","))
print(join_with_me("Olena", "Olya", "Oleh"))
# -------------------------------------------------------------------------------------
...
def format_options(**kwargs):
    ...
    for key, value in kwargs.items():
        items.append(f"{prefix} {key} = {value} {suffix}")
    return " ; ".join(items)
print(format_options(a=1, b=2, prefix="[", suffix="]"))
print(format_options(x=10, y=20))
# -------------------------------------------------------------------------------------
...
def format_data(main_title, *items, **options):
    ...
    items_string = separator.join(formatted_items)
    return f"{main_title}: {items_string}"
...
print(is_even(3)) # Ваш код тут, замініть None на лямбда-функцію
...
def filter_positive_numbers(numbers):
    filtered_numbers = list(filter(lambda y: y > 0, numbers))
    return filtered_numbers
original_list = [-1, 2, -3, 4, 0, 5]
print(filter_positive_numbers(original_list))