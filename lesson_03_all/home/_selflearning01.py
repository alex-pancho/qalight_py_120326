...
# Ваш код тут:
student_name = "Олександр"  # Замініть на ваше ім'я
student_age = 38    # Замініть на ваш вік
is_enrolled = True # Замініть на True якщо навчаєтеся
gpa_score = 10.9    # Замініть на ваш середній бал
...
# Ваш код тут:
rectangle_area = 103.75     # width * height
rectangle_perimeter = 41.6 # 2 * (width + height)
...
# Ваш код тут:
char_at_0 = "P"           # Символ на позиції 0
char_at_5 = "a"           # Символ на позиції 5
char_at_minus_1 = "g"     # Останній символ (індекс -1)
char_at_minus_3 = "i"     # Третій з кінця (індекс -3)
...
# Ваш код тут:
first_five = "Hello"          # Перші 5 символів
middle_part = "World"         # Символи з 6 по 10 включно
last_six = "Python"            # Останні 6 символів
every_second = "HloWrdPto"        # Кожен другий символ
...
result1 = 26              # (x + y) * z
result2 = 998              # x ** y - z
result3 = 7.333333333333            # (x / y) + (z * 2)
result4 = 5            # x % y + z ** 2
